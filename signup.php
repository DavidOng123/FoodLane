			...
			<form class="form-detail" action="#" method="post">
				...
				<div class="form-row">
					...
					<label for="your-phone">Your Phone</label>
                                        <input type="text" name="your-phone" id="your-phone" class="input-number" placeholder="Your Phone" required>
					<i class="fas fa-phone"></i>
				</div>
                                <div class="form-row">
					<label for="your-address">Your Address</label>
                                        <input type="text" name="your-address" id="your-address" class="input-text" placeholder="Your Address" required>
